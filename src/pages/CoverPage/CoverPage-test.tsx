...
const CoverPage = () => {
  ...
  return (
    <div className="px-4 sm:px-0 lg:px-35">
      {/* Render the CoverPage Navbar */}
      ...
      <div className="relative">
        ...
        {/* Text Section */}
        <div className="absolute top-1/3 left-4 lg:left-8 text-white sm:left-8 text-center sm:text-left mt-8 sm:mt-10">
          <p className="text-[14px] sm:text-[16px] lg:text-[18px]">
            Your Trusted Partner for Seamless Innovation and Success.
          </p>
          <p className="text-[24px] sm:text-[28px] lg:text-[32px] font-bold mt-4" style={{ textShadow: "3px 3px 6px rgba(0, 0, 0, 0.7)", WebkitTextStroke: "1px #000000" }}>
            Empowering growth through{" "}
            <span className="text-[#f75d2d]" style={{ textShadow: "3px 3px 6px rgba(0, 0, 0, 0.7)", WebkitTextStroke: "1px #000000" }}>
              {currentValue}
            </span>
          </p>
        </div>
